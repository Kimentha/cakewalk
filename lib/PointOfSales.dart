...
class POSState extends State<POS> {
  ...
  Future<List<String>> readItems() async {
    ...
    try {
      ...
      for (QueryDocumentSnapshot documentSnapshot in querySnapshot.docs) {
        ...
        if (data != null && data.containsKey('Product_Name')) {
          ...
          // Add the product name to the Set to ensure uniqueness
    ...
    productNames = productNamesSet.toList();
    return productNames;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Material(
        ...
        child: FutureBuilder(
          future: readItems(), // Use readItems() method as the future
                          ...
                          DecoratedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                ...
                                double totalPrice = itemPrices[itemName] != null
                                    ? itemPrices[itemName]! * itemQuantity
                                    : 0;
                                ...
                                final saleData = {
                                  ...
                                  'Sale_ID': null,
                                  // Leave it null for Firestore to auto-generate
                                  // Other sale-related data like customer information, total price, etc.
                                };

                                // Create a new sale document in Firestore
                                final saleDocRef = await FirebaseFirestore.instance.collection('SALE').add(saleData);
                                ...
                                Fluttertoast.showToast(
                                  msg: 'Total Price: \$${totalPrice.toStringAsFixed(2)}',
